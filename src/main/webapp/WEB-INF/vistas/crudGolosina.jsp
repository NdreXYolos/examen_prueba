 ...
 <h1>Crud de Golosina</h1>
		 <div class="col-md-23" >  
			  <form id="idFormElimina" action="eliminaCrudGolosina">
		       ...
		       <form accept-charset="UTF-8"  action="consultaCrudGolosina" class="simple_form" id="defaultForm2"  method="post">
					<div class="row">
						<div class="col-md-3">	
		                        ...
		                        <div class="panel panel-default">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
				                                 <label class="control-label" for="id_reg_fechaVencimiento">Fecha de Vencimiento</label>
			                                	<input class="form-control" type="date" id="id_reg_fechaVencimiento" name="fechaVencimiento" placeholder="La fecha de vencimiento" maxlength="100">    
		                                	</div>   
		                                    <div class="form-group">
				                                 <label class="control-label" for="id_reg_fechaRegistro">Fecha de Registro</label>
			                                	<input class="form-control" type="date" id="id_reg_fechaRegistro" name="fechaRegistro" placeholder="La fecha de Registrp" maxlength="100">    
		                                	</div>    
		                                    <div class="form-group">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
		                                           <input class="form-control" id="id_ID" readonly="readonly" name="idGolosina" type="text" maxlength="8"/>
		                                        </div>
		                                     </div>
		                                     <div class="form-group">
		                                    ...
		                                    <div class="form-group">
				                                 <label class="control-label" for="id_act_fechaVencimiento">Fecha de Vencimiento</label>
			                                	<input class="form-control" type="date" id="id_act_fechaVencimiento" name="fechaVencimiento" placeholder="La fecha de vencimiento" maxlength="100">    
		                                	</div>   
		                                    <div class="form-group">
				                                 <label class="control-label" for="id_act_fechaRegistro">Fecha de Registro</label>
			                                	<input class="form-control" type="date" id="id_act_fechaRegistro" name="fechaRegistro" placeholder="La fecha de Registrp" maxlength="100">    
		                                	</div>
